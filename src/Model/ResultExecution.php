...
/**
 * ResultExecution Class Doc Comment
 *
 * @category Class
 * @package  Qase\APIClientV2
 * @author   OpenAPI Generator team
 ...
 */
class ResultExecution implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResultExecution';
    ...
    */
     ...
     * Sets duration
     *
     * @param int|null $duration Duration of the test execution in milliseconds.
     *
     * @return self
     */
     ...
     * Sets thread
     *
     * @param string|null $thread thread
     *
     * @return self
     */
